...
class ContentController extends Controller{
    const ENTITY_NAME = 'Content';
    /**
     * @Security("has_role('ROLE_ADMIN')")
     * @Route("", name="admin_content_list")
     * @Template()
     */
    ...
    /**
     * @Security("has_role('ROLE_ADMIN')")
     * @Route("/add", name="admin_content_add")
     * @Template()
     */
    public function addAction(Request $request){
        ...
        if ($request->getMethod() == 'POST'){
            if ($formData->isValid()){
                ...
                $em->flush();
                $em->refresh($item);
                return $this->redirect($this->generateUrl('admin_content_list'));
            }
        }
    ...
    /**
     * @Security("has_role('ROLE_ADMIN')")
     * @Route("/remove/{id}", name="admin_content_remove")
     */
